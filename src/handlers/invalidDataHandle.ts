...
/* Module */
const debug: appDebugger.IDebugger = appDebugger('module:invalid-data-handler');

// eslint-disable-next-line prefer-arrow/prefer-arrow-functions
function invalidDataHandle(app: App, messageKey: string, errors: { message: string }[], status?: number): (req: Request, res: Response, next?: NextFunction) => void {
